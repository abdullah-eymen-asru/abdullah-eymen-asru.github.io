...
<!--
  ...
  Bu sayfanın tüm içeriği /panel/dashboard.html içindeki "Admin Güvenliği"
...
<div id="eski-panel-yonlendir" data-hedef="#sys-guvenlik"></div>

<h1>Panel taşındı</h1>
<p class="muted">
  Bu sayfa artık birleşik yönetim panelinin <strong>Admin Güvenliği</strong>
  sekmesi. Yönlendiriliyorsun&hellip;
</p>
<p>
  <a class="btn-primary csp-inline-block-link" href="{{ '/panel/dashboard.html' | relative_url }}#sys-guvenlik">
    Panele git
  </a>
</p>
