...
<!--
  ...
  Bu sayfanın tüm içeriği /panel/dashboard.html içindeki "Panelim"
...
<div id="eski-panel-yonlendir" data-hedef="#me-panel"></div>

<h1>Panel taşındı</h1>
<p class="muted">
  Bu sayfa artık birleşik yönetim panelinin <strong>Panelim</strong>
  sekmesi. Yönlendiriliyorsun&hellip;
</p>
<p>
  <a class="btn-primary csp-inline-block-link" href="{{ '/panel/dashboard.html' | relative_url }}#me-panel">
    Panele git
  </a>
</p>
