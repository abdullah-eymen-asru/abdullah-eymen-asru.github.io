...
<!--
  ...
  Bu sayfanın tüm içeriği /panel/dashboard.html içindeki "İzleme ve Okuma Yönetimi"
...
<div id="eski-panel-yonlendir" data-hedef="#media-izleme"></div>

<h1>Panel taşındı</h1>
<p class="muted">
  Bu sayfa artık birleşik yönetim panelinin <strong>İzleme ve Okuma Yönetimi</strong>
  sekmesi. Yönlendiriliyorsun&hellip;
</p>
<p>
  <a class="btn-primary csp-inline-block-link" href="{{ '/panel/dashboard.html' | relative_url }}#media-izleme">
    Panele git
  </a>
</p>
