...
<div class="auth-box">
  ...
  <div id="auth-expired" hidden>
    ...
    <a class="btn-primary csp-block-center-link" href="{{ '/hesap/sifremi-unuttum.html' | relative_url }}">Yeni Sıfırlama Linki İste</a>
  </div>
